...
- Example simulation data: available via the repository’s [releases](https://github.com/GEMDAT-repos/Workshop-2025/releases) as downloadable assets
...
## Troubleshooting
If you run into issues, please open an issue in [this repository](https://github.com/GEMDAT-repos/GEMDAT).
